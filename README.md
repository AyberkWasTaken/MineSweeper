...
✨ Key Features
    ...
    Recursive Reveal: Efficient flood-fill algorithm that automatically expands empty areas and their numbered boundaries.

    Dynamic Theme Support: Toggle between Dark and Light modes in real-time with a dedicated UI button.

    In-Game Timer: Precision tracking of your game duration to challenge your best times.
...
🎮 Controls
    ...
    Theme Button: Toggle visual styles.
